...
function App() {
  ...
  const contractAddress = "0x2904d9A6C375fBD8C94F9Ac654e0c5f2970E764f"; // Paste the address recieved from Remix IDE here
      ...
      <header className="App-header">
        ...
        : (
          <div>
            ...
            <div style={{width: '100%', height:'auto', backgroundColor: 'rgba(28, 42, 81, 0.2)', borderRadius:'8px'}}>
              Number of People Registered: {people.length}
            </div>
